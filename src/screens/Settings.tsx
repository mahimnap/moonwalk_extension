...
import { ScrollView, View, Linking, DevSettings } from "react-native";
    ...
    [
      {
        ...
        icon: "ChevronRight", 
        action: () => navigation.navigate("Saved Articles"), 
      },
      {
        title: "Shared Lists",
        icon: "ChevronRight", 
        action: () => navigation.navigate("Shared Lists"), 
      },
      {
        title: "Saved Launches",
        icon: "ChevronRight", 
        action: () => navigation.navigate("Saved Launches"), 
      },
    ],
    [
      {
